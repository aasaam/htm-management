...
describe(__filename.replace(__dirname, ''), () => {
  ...
  it('graphql single protection', async () => {
    const { token } = await helper.CreateUserHeaderAndToken(
      'makeproesingle@gmail.com',
      ['SA'],
      true,
    );
    ...
    expect(data.SingleProtection).toBeTruthy();
        ...
        query: `
          query(
            ...
            SingleProtection(
              ...
              id name country cidr asn asnRange
            }
          }
        `,
        variables: {
        ...
        query: `
          query(
            ...
            SingleProtection(
              ...
              id name country cidr asn asnRange clientToken
            }
          }
        `,
        variables: {
